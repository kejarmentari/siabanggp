                    ...
                    .bindPopup(`
                                <div style="width: 300px!important;">
                                    ...
                                    <div class="detail" style="display:none">
                                        ...
                                        ${resp.surveys[survey].foto == null ? '<h5 class="font-weight-normal"><i class="mdi mdi-arrow-right mr-0 text-info"></i>Video tidak tersedia</h5>' : '<img class=" mb-3"  width="100%" src="http://127.0.0.1:8000/storage/foto/${resp.surveys[survey].foto}" />'}
