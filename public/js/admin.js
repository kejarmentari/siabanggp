...
$(function () {
    ...
    if ($('input[name="latitude"]').val() == '' || $('input[name="longitude"]').val() == '') {
        createMap.setView([-1.260325, 116.8219728], 30);
        L.marker([-1.260325, 116.8219728], 30).addTo(createMap);
    } else {
        createMap.setView([parseFloat($('input[name="latitude"]').val()), parseFloat($('input[name="longitude"]').val())], 30)
        L.marker([parseFloat($('input[name="latitude"]').val()), parseFloat($('input[name="longitude"]').val())], 30).addTo(createMap);
    }
