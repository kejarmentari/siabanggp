                ...
                <div class="card mb-1">
                    <div class="card-body p-2">
                        <div class="row no-gutters">
                            <div class="col-md-1">
                                <div class="badge badge-info"><h2>1</h2></div>
                            </div>
                            <div class="col-md-11 pl-3 pt-2">
                                <h5 class="card-title mb-1">Kelurahan Manggar</h5>
                                <h6 class="card-subtitle mb-0 text-muted mt-1">Kode : A.2</h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <a href="#" class="list-card">
                <div class="card mb-2">
                    <div class="card-body p-2">
                        <div class="row no-gutters">
                            <div class="col-md-1">
                                <div class="badge badge-success"><h2>2</h2></div>
                            </div>
                            <div class="col-md-11 pl-3 pt-2">
                                <h5 class="card-title mb-1">Kelurahan Lamaru</h5>
                                <h6 class="card-subtitle mb-0 text-muted mt-1">Kode : A.3</h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <a href="#" class="list-card">
                <div class="card mb-2">
                    <div class="card-body p-2">
                        <div class="row no-gutters">
                            <div class="col-md-1">
                                <div class="badge badge-info"><h2>3</h2></div>
                            </div>
                            <div class="col-md-11 pl-3 pt-2">
                                <h5 class="card-title mb-1">Kelurahan Baru Ilir</h5>
                                <h6 class="card-subtitle mb-0 text-muted mt-1">Kode : A.4</h6>
                            </div>
                        </div>
                    </div>
                </div>
